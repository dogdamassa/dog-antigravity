            ...
            <div className="max-w-[980px] mx-auto px-4 md:px-6 py-12 md:py-16 space-y-4">
                {eduSections.map((section) => (
                    ...
                    >
                        ...
                        {/* Logo strip — full width, Apple-style */}
                        <div
                            className="w-full flex items-center justify-center py-8 mb-8 rounded-2xl relative z-10"
                            style={{ background: section.iconBg === "#FFFFFF" ? "rgba(255,255,255,0.06)" : "rgba(255,255,255,0.03)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}
                        >
                            <img
                                src={section.image}
                                alt={section.title}
